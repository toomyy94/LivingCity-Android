            ...
            if (fbDataInStations.size() == 0 || fbDataInStations == null) SystemClock.sleep(600);
                ...
                if(qualidade_do_ar>2){
                    ...
                    districts.add(googleMap.addPolygon(new PolygonOptions()
                            ...
                            .fillColor(Color.argb(60, 0, 120, 0))));//0
                    ...
                    districts.add(googleMap.addPolygon(new PolygonOptions()
                            ...
                            .strokeColor(Color.argb(90, 0, 100, 0)).strokeWidth(4)
                            .fillColor(Color.argb(0, 0, 120, 0))));
                    ...
                    districts.add(googleMap.addPolygon(new PolygonOptions()
                            ...
                            .strokeColor(Color.argb(90, 0, 100, 0)).strokeWidth(4)
                            .fillColor(Color.argb(60, 0, 120, 0))));
                    ...
                    districts.add(googleMap.addPolygon(new PolygonOptions()
                            ...
                            .strokeColor(Color.argb(90, 0, 100, 0)).strokeWidth(4)
                            .fillColor(Color.argb(60, 0, 120, 0))));//3
                    ...
                    districts.add(googleMap.addPolygon(new PolygonOptions()
                            ...
                            .strokeColor(Color.argb(90, 0, 100, 0)).strokeWidth(4)
                            .fillColor(Color.argb(60, 0, 120, 0))));//4
                    ...
                    districts.add(googleMap.addPolygon(new PolygonOptions()
                            ...
                            .strokeColor(Color.argb(90, 0, 100, 0)).strokeWidth(6)
                            .fillColor(Color.argb(0, 0, 120, 0))));
                    ...
                    districts.add(googleMap.addPolygon(new PolygonOptions()
                            ...
                            .strokeColor(Color.argb(90, 0, 100, 0)).strokeWidth(4)
                            .fillColor(Color.argb(60, 0, 120, 0)))); //6
                    ...
                    districts.add(googleMap.addPolygon(new PolygonOptions()
                            ...
                            .strokeColor(Color.argb(90, 0, 100, 0)).strokeWidth(4)
                            .fillColor(Color.argb(60, 0, 120, 0)))); //8
                    ...
                    districts.add(googleMap.addPolygon(new PolygonOptions()
                            ...
                            .strokeColor(Color.argb(90, 0, 100, 0)).strokeWidth(4)
                            .fillColor(Color.argb(60, 0, 120, 0)))); //10
                    ...
                    districts.add(googleMap.addPolygon(new PolygonOptions()
                            ...
                            .strokeColor(Color.argb(190, 0, 100, 0)).strokeWidth(4)
                            .fillColor(Color.argb(60, 0, 120, 0)))); //11
                    ...
                    districts.add(googleMap.addPolygon(new PolygonOptions()
                            ...
                            .strokeColor(Color.argb(190, 0, 100, 0)).strokeWidth(4)
                            .fillColor(Color.argb(60, 0, 120, 0)))); //14
                    ...
                    districts.add(googleMap.addPolygon(new PolygonOptions()
                            ...
                            .strokeColor(Color.argb(90, 0, 100, 0)).strokeWidth(4)
                            .fillColor(Color.argb(60, 0, 120, 0)))); //17
                }
                else{
